    ...
    <div class="action">
        ...
        <ul>
            ...
            @foreach ($modules as $module)
                @php $compte++; @endphp
                <a href="{{route('TemplateController.editModule',['prestation'=>'tout','moduleId'=>$module->id])}}" class="fas fa-edit"></a><br>
        ...
        <h2>Etiquettes</h2>
        <a href="{{Route('TemplateController.ajoutEtiquette')}}" class="fas fa-plus-circle"></a><br><br>
        @foreach ($etiquettes as $etiquette)
