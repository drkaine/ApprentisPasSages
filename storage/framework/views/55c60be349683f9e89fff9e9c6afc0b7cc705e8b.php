          ...
          <ul>
            ...
            <ul class="dropdown-menu">
                <?php $__currentLoopData = $catalogues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalogue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($catalogue->nom == "Soutien scolaire"): ?>
                        <li><a href="Soutien-scolaire"><?php echo e($catalogue->nom); ?></a></li>
                    <?php else: ?>
                        <li><a href="<?php echo e($catalogue->nom); ?>"><?php echo e($catalogue->nom); ?></a></li>
                    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\apprentisPasSages\resources\views/template.blade.php ENDPATH**/ ?>