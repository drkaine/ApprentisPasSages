...
<div class="row">
    <?php $__currentLoopData = $team; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('team-accueil', compact($membre), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('js/jQCloud/dist/jqcloud.min.js')); ?>"></script>
<script>
    var words = [
      ...
      <?php $rand = rand(1,7) ?>
      {text: "<?php echo $c->nom; ?>",weight:<?php echo e($rand); ?>,link:"<?php echo e($c->lien); ?>"},

      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
];
</script>
<script type="application/javascript" src="<?php echo e(asset('js/main.js')); ?>"></script>
...
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\apprentisPasSages\resources\views/accueil.blade.php ENDPATH**/ ?>